...
(function () {
    ...
    window.closeWbCookieNotifier = function () {
        ...
        if (document.getElementById('header') != null) {
            ...
            jQuery('#header .topbar').css('top', 0);
        }
    }
    ...
    function showWbCookieNotifier() {
        ...
        if (document.getElementById('header') != null) {
            document.getElementById('header').style.marginTop = window.wbCookieNotifier.clientHeight + 'px';
            jQuery('#header .topbar').css('top', window.wbCookieNotifier.clientHeight + 'px');
        }
